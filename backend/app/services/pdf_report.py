...
def generate_screening_pdf(
    ...
    # 7. Safety Disclaimer & Signature Block
    disclaimer_p = Paragraph(
        "<b>CLINICAL DISCLAIMER:</b> This document is generated by the RetinaAI AI-assisted screening decision support system. "
        "The AI severity classification and Grad-CAM saliency heatmaps represent preliminary algorithmic screening results "
        "and <b>do not constitute an independent medical diagnosis</b>. Retinal examinations must be validated by a licensed "
        "ophthalmologist, optometrist, or trained medical specialist prior to initiating therapeutic interventions.",
        disclaimer_style
    )
